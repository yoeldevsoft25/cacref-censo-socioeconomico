...
// Estados de Venezuela (24 entidades federales: 23 estados + Distrito Capital).
// Ordenados alfabéticamente para fácil navegación. Incluye "Extranjero" para
// trabajadores petroleros radicados fuera de Venezuela.
...
// Municipios por estado. Los estados con mayor actividad petrolera
// (Zulia, Falcón, Anzoátegui, Monagas, Sucre, Carabobo, Bolívar, Miranda, Distrito Capital)
// tienen TODOS sus municipios. Los demás solo los más poblados.
// La opción '' permite "No especifica" en cualquier estado.
...
// Helper: municipios para un estado. Devuelve array vacío si el estado no existe.
export function getMunicipiosForEstado(estado: string | null | undefined): string[] {
  if (!estado) return [];
